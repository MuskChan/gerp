  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- COLOR PALETTE -->
        <!-- START PROGRESS BARS -->
        <h5 class="mt-4 mb-2">知识体系</h5>

        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">工作技能</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <p><code>PHP</code></p>
                ...
                <div class="progress ">
                  <div class="progress-bar progress-bar-info bg-info progress-bar-striped" role="progressbar"
                       aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
